...
<script type="text/javascript">
    ...
    scanner.addListener("scan", function (content) {
        ...
        if (lower.includes("s1-teknik komputer") === true) {
            var dar = document.getElementById("formregistrasi");
            dar.style.display = 'block';
            dar.insertAdjacentHTML('beforeend', `<div class="row justify-content-center align-items-center h-100">
        <div class="col-12 col-lg-9 col-xl-7">
            ...
            cek.remove();
            alert("Anda Mahasiswa Teknik Komputer, Silahkan Registrasi.")
        } else {
