...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h5 mb-0 text-light">Form Tambah Stock</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard')}}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/stock')}}">Stock</a></li>
            <li class="breadcrumb-item">Tambah Stock</li>
        </ol>
    </div>
    ...
    <div class="card shadow border-0 mb-4 bgdark ">
        <form method="POST" action="{{route('stock.store')}}">
            ...
            <div class="card-footer bgdark border-0">
                ...
                <a class="btn btn-danger float-right mr-3 mb-3" href="{{ route('stock.index') }}">Batal</a>
            </div>
        </form>
    </div>
