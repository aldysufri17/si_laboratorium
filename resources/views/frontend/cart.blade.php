                                ...
                                <div class="card-body p-4">
                                    <div class="row d-flex justify-content-between align-items-center">
                                        <div class="col-md-1 col-lg-1 col-xl-1">
                                            <input style="border: 1px solid black" class="form-check-input checkbox"
                                                type="checkbox" id="" name="ckd_chld[]" value="{{$data->id}}"
                                                @if($data->tgl_start == null || $data->tgl_end == null || $data->jumlah
                                            ==
                                            null || $data->kategori_lab == null || $data->alasan == null)
                                            disabled
                                            @endif>
                                        </div>
