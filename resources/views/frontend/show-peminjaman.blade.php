                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex align-items-center">
                                            <h3 style="font-weight: bold" class="mx-2 mt-3">
                                                ...
                                                0)->select('created_at')->groupBy('created_at')->get()
                                                @endphp
                                                {{ $data->count() }}
                                            </h3>
                                        </div>
                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex align-items-center">
                                            <h3 style="font-weight: bold" class="mx-2 mt-3">
                                                ...
                                                $data = App\Models\Peminjaman::where('user_id',
                                                auth()->user()->id)->where('status',
                                                2)->select('created_at')->groupBy('created_at')->get()
                                                @endphp
                                                {{ $data->count() }}
                                            </h3>
                                        </div>
                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex align-items-center">
                                            <h3 style="font-weight: bold" class="mx-2 mt-3">
                                                ...
                                                $data = App\Models\Peminjaman::where('user_id',
                                                auth()->user()->id)->where('status',
                                                1)->select('created_at')->groupBy('created_at')->get()
                                                @endphp
                                                {{ $data->count() }}
                                            </h3>
                                        </div>
                        ...
                        <table id="dataTable" class="table table-borderless dt-responsive" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    $data = App\Models\Peminjaman::where('user_id',
                                    auth()->user()->id)->where('created_at', $datetime)->first();
                                    $status = $data->status;
                                    @endphp
                                    <td class="text-center">
                                        ...
                                        @elseif($status == 3)
                                        <p class="font-weight-bold text-center text-danger">MENUNGGU KONFIRMASI<br>
                                    ...
                                    <td class="d-sm-flex justify-content-center">
                                        <a href="{{route('peminjaman.show.detail', $data->created_at)}}"
                                            class="btn btn-primary" data-toggle="tooltip" data-placement="top"
                                            title="Show">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        @if ($status == 0)
                                        <a href="{{route('peminjaman.edit', $data->created_at)}}"
                                        ...
                                        @elseif ($status == 2)
                                        <button class="btn btn-info mx-2" disabled title="Delete">
                                            <i class="fa fa-pen"></i>
                                        </button>
                                        ...
                                        @elseif($status == 1)
                                        <button class="btn btn-info delete-btn" disabled title="Delete">
