        ...
        <div class="d-flex justify-content-between flex-wrap mx-5 my-4">
            <div class="card mt-3" style="width: 25rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-justify">Login terlebih dahulu, yaitu dengan memasukan email dan kata sandi, untuk halaman login bisa di akses <a href="{{route('login')}}">disini</a> </p>
                </div>
            </div>
            <div class="card mt-3" style="width: 25rem;">
            ...
            <div class="card mt-3" style="width: 25rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-justify">Gambar diatas adalah halaman daftar barang, Cari barang yang anda inginkan berdasarkan kategori laboratorium yang tersedia.</p>
                </div>
            </div>
            <div class="card mt-3" style="width: 25rem;">
            ...
            <div class="card mt-3" style="width: 25rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-justify">Setelah mengisi informasi peminjaman, Peminjam akan diarahkan ke halaman keranjang, Gambar diatas adalah halaman keranjang, yang mana terdapat daftar barang yang dipilih, tunggu hingga status pengajuan disetujui operator laboratorium terkait.</p>
                </div>
            </div>
            <div class="card mt-3" style="width: 25rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-justify">Setelah status peminjaman disetujui, maka peminjam harus melakukan cetak surat peminjaman untuk melakukan aktivasi peminjaman barang ke operator laboratorium terkait.</p>
                </div>
            </div>
        </div>
    </div>
